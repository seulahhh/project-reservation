...
import com.project.member.service.api.StoreApiService;
...
public class StoreProxyController {
    ...
    public String getStoreListOrderByDistance (
        ...
        if (sortBy.equals("distance")) {
            list = storeApiService.getStoreListOrderByDistance(location);
        } else if (sortBy.equals("name")) {
            list = storeApiService.getStoreListOrderByName(location);
        } else {
            list = storeApiService.getStoreListOrderByRating(location);
        }
    ...
    public String getStoreDetail(@PathVariable Long storeId, Model model) {
        StoreDto storeDetail = storeApiService.getStoreDetail(storeId);
    ...
    public String getStoreDetail(AddStoreForm form) {
        storeApiService.registerStore(form);
